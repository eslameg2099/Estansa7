...
class CategoryProviderRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'string', 'max:120','unique:category_providers,name'],
            'slug' => ['required', 'string', 'max:120', 'unique:category_providers,slug'],
    ...
    {
        return trans('categoryprovider.attributes');
    }
}
